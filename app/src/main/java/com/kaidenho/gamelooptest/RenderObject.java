...
/**
 * Created by Kaiden Ho on 2017-01-17.
 */
public class RenderObject extends BaseObject {
    private final static String TAG = RenderObject.class.getSimpleName();
     ...
     */
    public RenderObject (int textureIndex, Rect locationRect) {
        mTextureIndex = textureIndex;

        // Initial location
        mLocationRect = new Rect(locationRect);
