...
public class GameObject extends BaseObject {
     ...
     * @param name
     */
    public GameObject (int textureIndex, Rect locationRect, Context context, String name) {
        ...
        mTextureBuffer = setTextureBuffer(mTextureBuffer);
    ...
    private FloatBuffer setTextureBuffer(FloatBuffer mTextureBuffer)
    {
